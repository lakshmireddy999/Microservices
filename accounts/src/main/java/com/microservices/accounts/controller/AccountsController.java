...
@Tag(name = "CRUD rest api for accounts in DemoBank",
        description = "CRUD rest apis to CREATE,UPDATE,FETCH,DELETE account details")
@RestController
...
public class AccountsController {
    ...
    @Operation(summary = "Create Account in DemoBank")
